...
use super::terminal::{Color, Terminal, Verbosity};
...
#[derive(Args)]
#[command(
    after_help = "Unrecognized subcommands will be passed to cargo verbatim after relevant \
                  component bindings are updated."
)]
