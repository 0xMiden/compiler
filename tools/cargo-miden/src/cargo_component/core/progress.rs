...
use super::terminal::{Terminal, Verbosity};
...
mod test {
    ...
    fn test_progress_status() {
        ...
        assert_eq!(format.progress_status(0, 4, ""), Some("[                   ] 0/4".to_string()));
        assert_eq!(format.progress_status(1, 4, ""), Some("[===>               ] 1/4".to_string()));
        assert_eq!(format.progress_status(2, 4, ""), Some("[========>          ] 2/4".to_string()));
        assert_eq!(format.progress_status(3, 4, ""), Some("[=============>     ] 3/4".to_string()));
        assert_eq!(format.progress_status(4, 4, ""), Some("[===================] 4/4".to_string()));
    ...
    fn test_progress_status_too_short() {
        ...
        assert_eq!(format.progress_status(1, 1, ""), Some("[] 100.00%".to_string()));
