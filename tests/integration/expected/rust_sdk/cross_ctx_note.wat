(component
  ...
  (core module (;0;)
    ...
    (func $miden:base/note-script@1.0.0#note-script (;6;) (type 5) (param f32 f32 f32 f32)
      (local i32 f32)
  ...
  (alias core export 2 "miden:base/note-script@1.0.0#note-script" (core func (;4;)))
  ...
  (component (;0;)
    ...
    (import "import-func-note-script" (func (;0;) (type 6)))
    (export (;7;) "word" (type 4))
    (type (;8;) (func (param "arg" 7)))
    (export (;1;) "note-script" (func 0) (func (type 8)))
  )
