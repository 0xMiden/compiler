(component
  ...
  (core module (;0;)
    ...
    (func $miden::faucet::create_fungible_asset (;7;) (type 5) (param f32 i32)
      unreachable
    )
  ...
  (alias core export 0 "miden:rust-sdk-account-faucet-create-fungible-asset-binding/rust-sdk-account-faucet-create-fungible-asset-binding@0.0.1#binding" (core func (;0;)))
  ...
  (export (;2;) "miden:rust-sdk-account-faucet-create-fungible-asset-binding/rust-sdk-account-faucet-create-fungible-asset-binding@0.0.1" (instance 1))
)
