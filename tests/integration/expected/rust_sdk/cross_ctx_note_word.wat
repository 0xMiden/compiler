(component
  ...
  (core module (;0;)
    ...
    (func $miden:base/note-script@1.0.0#note-script (;12;) (type 9) (param f32 f32 f32 f32)
  ...
  (alias core export 3 "miden:base/note-script@1.0.0#note-script" (core func (;16;)))
  ...
  (instance (;3;) (instantiate 0
      (with "import-func-note-script" (func 10))
