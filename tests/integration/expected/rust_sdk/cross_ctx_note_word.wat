(component
  ...
  (core module $main (;0;)
    ...
    (func $miden:base/note-script@1.0.0#run (;9;) (type 6) (param f32 f32 f32 f32)
      ...
      call $intrinsics::felt::assert_eq
      local.get 12
      call $<miden_felt::Felt as core::convert::From<u16>>::from
      i32.const 12
      call $intrinsics::felt::from_u32
      call $intrinsics::felt::assert_eq
      i32.const 30
    ...
    (func $<miden_felt::Felt as core::convert::From<u16>>::from (;15;) (type 8) (param i32) (result f32)
      local.get 0
      i32.const 65535
      i32.and
      f32.reinterpret_i32
    )
    (func $<miden_felt::Felt as core::convert::From<u8>>::from (;16;) (type 8) (param i32) (result f32)
      local.get 0
      i32.const 255
      i32.and
      f32.reinterpret_i32
