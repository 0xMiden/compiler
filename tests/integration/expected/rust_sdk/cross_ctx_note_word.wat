(component
  ...
  (core module (;0;)
    ...
    (func $miden:base/note-script@1.0.0#run (;12;) (type 9) (param f32 f32 f32 f32)
  ...
  (alias core export 3 "miden:base/note-script@1.0.0#run" (core func (;16;)))
