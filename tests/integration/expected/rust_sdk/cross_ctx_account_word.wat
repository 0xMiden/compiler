(component
  ...
  (core module (;0;)
    ...
    (type (;7;) (func (param i64 f32 i32 f32) (result i32)))
    ...
    (func $miden:cross-ctx-account-word/foo@1.0.0#process-mixed (;9;) (type 7) (param i64 f32 i32 f32) (result i32)
      (local i32)
      global.get $GOT.data.internal.__memory_base
      local.set 4
      call $wit_bindgen_rt::run_ctors_once
  ...
  (type (;10;) (record (field "f" u64) (field "a" 4) (field "b" u32) (field "c" 4)))
  ...
  (component (;0;)
    ...
    (type (;15;) (record (field "f" u64) (field "a" 7) (field "b" u32) (field "c" 7)))
    ...
    (type (;27;) (record (field "f" u64) (field "a" 22) (field "b" u32) (field "c" 22)))
