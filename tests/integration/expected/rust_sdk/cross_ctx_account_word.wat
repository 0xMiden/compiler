(component
  ...
  (type (;5;) (record (field "x" 3) (field "y" 3) (field "z" 3)))
  (type (;6;) (record (field "f" u64) (field "a" 3) (field "b" u32) (field "c" 3) (field "d" u8) (field "e" bool) (field "g" u16)))
  ...
  (instance (;2;) (instantiate 0
      ...
      (with "import-type-pair" (type 4))
      (with "import-type-triple" (type 5))
      (with "import-type-mixed-struct" (type 6))
      (with "import-type-nested-struct" (type 7))
    )
  )
