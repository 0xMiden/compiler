(component
  ...
  (core module (;0;)
    ...
    (func $miden::faucet::mint (;8;) (type 4) (param f32 f32 f32 f32 i32)
      unreachable
    )
  ...
  (alias core export 0 "miden:rust-sdk-account-faucet-mint-binding/rust-sdk-account-faucet-mint-binding@0.0.1#binding" (core func (;0;)))
  ...
  (export (;2;) "miden:rust-sdk-account-faucet-mint-binding/rust-sdk-account-faucet-mint-binding@0.0.1" (instance 1))
)
