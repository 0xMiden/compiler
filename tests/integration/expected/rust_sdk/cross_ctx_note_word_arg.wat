(component
  ...
  (core module (;0;)
    ...
    (func $miden:base/script@1.0.0#script (;5;) (type 4) (param f32 f32 f32 f32)
  ...
  (alias core export 2 "miden:base/script@1.0.0#script" (core func (;3;)))
  ...
  (instance (;3;) (instantiate 0
      (with "import-func-script" (func 3))
