(component
  ...
  (core module $main (;0;)
    ...
    (type (;5;) (func (param f32 f32 f32 f32 f32 f32 f32 f32) (result f32)))
    (table (;0;) 2 2 funcref)
    (memory (;0;) 17)
    ...
    (func $miden_base_sys::bindings::output_note::create (;4;) (type 2) (param f32 f32 f32 f32 i32) (result f32)
      local.get 0
      local.get 1
      local.get 2
      local.get 3
    ...
    (func $<miden_base_sys::bindings::types::Asset as core::convert::From<[miden_felt::wasm32::Felt; 4]>>::from (;5;) (type 3) (param i32 i32)
      local.get 0
      local.get 1
