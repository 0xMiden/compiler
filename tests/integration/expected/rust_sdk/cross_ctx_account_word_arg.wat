(component
  ...
  (core module (;0;)
    ...
    (func $cross_ctx_account_word_arg::bindings::__link_custom_section_describing_imports (;3;) (type 2))
    (func $miden:cross-ctx-account-word-arg/foo@1.0.0#process-word (;4;) (type 3) (param f32 f32 f32 f32 f32 f32 f32 f32 f32 f32 f32 f32 f32 f32 f32 f32) (result f32)
    ...
    (func $intrinsics::felt::add (;6;) (type 1) (param f32 f32) (result f32)
      unreachable
    )
  ...
  (alias core export 1 "miden:cross-ctx-account-word-arg/foo@1.0.0#process-word" (core func (;2;)))
