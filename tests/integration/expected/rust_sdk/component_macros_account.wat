(component
  ...
  (type (;5;) (record (field "value" 2)))
  (type (;6;) (record (field "nested" 5)))
  (type (;7;) (record (field "foo" 3) (field "asset" 1)))
  (type (;8;) (record (field "bar" 2) (field "baz" 2)))
  (type (;9;) (record (field "inner1" 2) (field "inner2" 2)))
  (type (;10;) (record (field "bar" 2) (field "baz" 2)))
  (core instance (;0;) (instantiate 0))
  (alias core export 0 "memory" (core memory (;0;)))
  (type (;11;) (func (param "a" 7) (param "asset" 1) (result 8)))
  (alias core export 0 "miden:component-macros-account/component-macros-account@0.1.0#test-custom-types" (core func (;0;)))
  (func (;0;) (type 11) (canon lift (core func 0) (memory 0)))
  (type (;12;) (func (param "a" 7) (param "asset" 1) (result 9)))
  (alias core export 0 "miden:component-macros-account/component-macros-account@0.1.0#test-custom-types2" (core func (;1;)))
  (func (;1;) (type 12) (canon lift (core func 1) (memory 0)))
