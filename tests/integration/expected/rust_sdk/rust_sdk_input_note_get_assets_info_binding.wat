(component
  ...
  (core module (;0;)
    ...
    (func $miden_base_sys::bindings::input_note::get_assets_info (;4;) (type 2) (param i32 f32)
      ...
      local.get 1
      local.get 2
      call $miden::input_note::get_assets_info
      local.get 2
      local.get 2
      i64.load offset=8
      i64.store offset=40
    ...
    (func $miden::input_note::get_assets_info (;7;) (type 5) (param f32 i32)
      unreachable
    )
    (data $.data (;0;) (i32.const 1048576) "\01\00\00\00\01\00\00\00")
    (@custom "rodata,miden_account" (after data) "Wrust_sdk_input_note_get_assets_info_binding\01\0b0.0.1\03\01\01\00\00\00\00\00\00\00\00\00\00")
  )
  (alias export 0 "felt" (type (;1;)))
  (core instance (;0;) (instantiate 0))
  (alias core export 0 "memory" (core memory (;0;)))
  (type (;2;) (func (result 1)))
  (alias core export 0 "miden:rust-sdk-input-note-get-assets-info-binding/rust-sdk-input-note-get-assets-info-binding@0.0.1#binding" (core func (;0;)))
  ...
  (export (;2;) "miden:rust-sdk-input-note-get-assets-info-binding/rust-sdk-input-note-get-assets-info-binding@0.0.1" (instance 1))
)
