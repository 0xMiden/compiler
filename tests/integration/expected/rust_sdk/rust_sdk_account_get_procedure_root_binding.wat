(component
  ...
  (core module (;0;)
    ...
    (func $miden::active_account::get_procedure_root (;6;) (type 4) (param f32 i32)
      unreachable
    )
  ...
  (alias core export 0 "miden:rust-sdk-account-get-procedure-root-binding/rust-sdk-account-get-procedure-root-binding@0.0.1#binding" (core func (;0;)))
  ...
  (export (;2;) "miden:rust-sdk-account-get-procedure-root-binding/rust-sdk-account-get-procedure-root-binding@0.0.1" (instance 1))
)
