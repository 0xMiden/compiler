(component
  ...
  (core module $main (;0;)
    ...
    (func $miden::native_account::add_asset (;8;) (type 5) (param f32 f32 f32 f32 i32)
      unreachable
    )
    (func $miden::native_account::remove_asset (;9;) (type 5) (param f32 f32 f32 f32 i32)
      unreachable
    )
    (func $miden::output_note::add_asset (;10;) (type 1) (param f32 f32 f32 f32 f32)
      unreachable
    )
