(component
  ...
  (core module (;0;)
    ...
    (import "miden:core-intrinsics/intrinsics-felt@1.0.0" "assert-eq" (func $miden_stdlib_sys::intrinsics::felt::extern_assert_eq (;3;) (type 2)))
    (table (;0;) 2 2 funcref)
    (memory (;0;) 17)
    ...
    (func $counter_note::bindings::__link_custom_section_describing_imports (;5;) (type 3))
    (func $miden:base/note-script@1.0.0#run (;6;) (type 4) (param f32 f32 f32 f32)
      (local f32)
    ...
    (data $.data (;0;) (i32.const 1048576) "\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00")
  )
  ...
  (alias export 2 "assert-eq" (func (;3;)))
  ...
  (alias core export 2 "miden:base/note-script@1.0.0#run" (core func (;4;)))
