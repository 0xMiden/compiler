(component
  ...
  (core module (;0;)
    ...
    (func $miden:base/note-script@1.0.0#run (;7;) (type 5) (param f32 f32 f32 f32)
      (local f32)
  ...
  (alias core export 2 "miden:base/note-script@1.0.0#run" (core func (;5;)))
