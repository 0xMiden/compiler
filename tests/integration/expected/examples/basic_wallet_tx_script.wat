(component
  ...
  (core module (;0;)
    ...
    (import "miden:basic-wallet/basic-wallet@1.0.0" "receive-asset" (func $basic_wallet_tx_script::bindings::miden::basic_wallet::basic_wallet::receive_asset::wit_import7 (;1;) (type 1)))
    ...
    (func $basic_wallet_tx_script::bindings::__link_custom_section_describing_imports (;7;) (type 5))
    ...
    (func $miden:base/script@1.0.0#script (;11;) (type 5)
      ...
      block ;; label = @1
        loop ;; label = @2
          ...
          local.get 1
          f32.load offset=12
          call $basic_wallet_tx_script::bindings::miden::basic_wallet::basic_wallet::receive_asset::wit_import7
          local.get 5
          i32.const -16
          i32.add
          local.set 5
