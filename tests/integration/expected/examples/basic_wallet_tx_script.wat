(component
  ...
  (import "miden:basic-wallet/basic-wallet@0.1.0" (instance (;1;) (type 3)))
  (core module (;0;)
    ...
    (data $.rodata (;0;) (i32.const 1048576) "miden-stdlib-sys-0.6.0/src/stdlib/mem.rs\00src/lib.rs\00")
