(component
  ...
  (core module $main (;0;)
    ...
    (func $<alloc::vec::Vec<miden_felt::Felt> as core::ops::index::Index<core::ops::range::Range<usize>>>::index (;7;) (type 4) (param i32 i32 i32 i32)
      (local i32)
      block ;; label = @1
        local.get 3
        local.get 1
    ...
    (func $miden:base/transaction-script@1.0.0#run (;8;) (type 5) (param f32 f32 f32 f32)
      ...
      block ;; label = @1
        block ;; label = @2
          ...
          i32.const 4
          i32.const 8
          call $<alloc::vec::Vec<miden_felt::Felt> as core::ops::index::Index<core::ops::range::Range<usize>>>::index
          local.get 4
          i32.load offset=12
          i32.const 4
          i32.ne
          ...
          i32.const 20
          i32.add
          call $<alloc::vec::Vec<miden_felt::Felt> as core::ops::drop::Drop>::drop
          local.get 4
          i32.const 20
          i32.add
          call $<alloc::raw_vec::RawVec<miden_felt::Felt> as core::ops::drop::Drop>::drop
          local.get 4
          i32.const 80
          i32.add
          global.set $__stack_pointer
    ...
    (func $<alloc::raw_vec::RawVec<miden_felt::Felt> as core::ops::drop::Drop>::drop (;13;) (type 8) (param i32)
      local.get 0
      i32.const 4
      i32.const 4
    ...
    (func $<miden_base_sys::bindings::types::Asset as core::convert::From<[miden_felt::Felt; 4]>>::from (;15;) (type 10) (param i32 i32)
      local.get 0
      local.get 1
    ...
    (func $<alloc::vec::Vec<miden_felt::Felt> as core::ops::drop::Drop>::drop (;16;) (type 8) (param i32))
    ...
    (func $<alloc::raw_vec::RawVecInner>::deallocate (;24;) (type 3) (param i32 i32 i32)
      (local i32)
      global.get $__stack_pointer
      i32.const 16
      i32.sub
    ...
    (func $<alloc::raw_vec::RawVecInner>::current_memory (;25;) (type 4) (param i32 i32 i32 i32)
      (local i32 i32 i32)
      i32.const 0
      local.set 4
      i32.const 4
    ...
    (func $<alloc::alloc::Global as core::alloc::Allocator>::deallocate (;26;) (type 3) (param i32 i32 i32)
      block ;; label = @1
        local.get 2
        i32.eqz
        br_if 0 (;@1;)
    ...
    (func $<alloc::alloc::Global as core::alloc::Allocator>::allocate (;27;) (type 3) (param i32 i32 i32)
      (local i32)
      global.get $__stack_pointer
      i32.const 16
      i32.sub
    ...
    (func $<alloc::raw_vec::RawVecInner>::try_allocate_in (;28;) (type 17) (param i32 i32 i32 i32 i32)
      (local i32 i64)
      global.get $__stack_pointer
      i32.const 16
      i32.sub
    ...
    (func $alloc::raw_vec::handle_error (;29;) (type 10) (param i32 i32)
      unreachable
    )
    (func $core::slice::index::slice_index_fail::do_panic::runtime (;30;) (type 3) (param i32 i32 i32)
      unreachable
    )
    (func $<core::ptr::alignment::Alignment>::max (;31;) (type 2) (param i32 i32) (result i32)
      local.get 0
      local.get 1
      local.get 0
      local.get 1
