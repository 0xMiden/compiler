(component
  ...
  (core module $main (;0;)
    ...
    (func $<alloc::vec::Vec<miden_felt::wasm32::Felt> as core::ops::index::Index<core::ops::range::Range<usize>>>::index (;7;) (type 4) (param i32 i32 i32 i32)
      (local i32)
      block ;; label = @1
        local.get 3
        local.get 1
    ...
    (func $miden:base/transaction-script@1.0.0#run (;8;) (type 5) (param f32 f32 f32 f32)
      ...
      block ;; label = @1
        block ;; label = @2
          ...
          i32.const 4
          i32.const 8
          call $<alloc::vec::Vec<miden_felt::wasm32::Felt> as core::ops::index::Index<core::ops::range::Range<usize>>>::index
          local.get 4
          i32.load offset=12
          i32.const 4
          i32.ne
    ...
    (func $<alloc::raw_vec::RawVec<miden_felt::wasm32::Felt> as core::ops::drop::Drop>::drop (;13;) (type 8) (param i32)
      local.get 0
      i32.const 4
      i32.const 4
    ...
    (func $<miden_base_sys::bindings::types::Asset as core::convert::From<[miden_felt::wasm32::Felt; 4]>>::from (;15;) (type 10) (param i32 i32)
      local.get 0
      local.get 1
    ...
    (func $<alloc::vec::Vec<miden_felt::wasm32::Felt> as core::ops::drop::Drop>::drop (;16;) (type 8) (param i32))
