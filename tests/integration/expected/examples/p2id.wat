(component
  ...
  (core module $main (;0;)
    ...
    (func $<alloc::raw_vec::RawVec<miden_felt::wasm32::Felt> as core::ops::drop::Drop>::drop (;13;) (type 6) (param i32)
      local.get 0
      i32.const 4
      i32.const 4
      call $<alloc::raw_vec::RawVecInner>::deallocate
    ...
    (func $<alloc::vec::Vec<miden_felt::wasm32::Felt> as core::ops::drop::Drop>::drop (;17;) (type 6) (param i32))
