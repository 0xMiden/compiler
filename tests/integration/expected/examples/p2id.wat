(component
  ...
  (core module (;0;)
    ...
    (global $GOT.data.internal.__rust_no_alloc_shim_is_unstable (;2;) i32 i32.const 1048680)
    ...
    (func $__rustc::__rust_dealloc (;8;) (type 7) (param i32 i32 i32))
    (func $__rustc::__rust_alloc_zeroed (;9;) (type 6) (param i32 i32) (result i32)
      block ;; label = @1
        global.get $GOT.data.internal.__memory_base
        i32.const 1048676
        i32.add
    ...
    (func $wit_bindgen_rt::run_ctors_once (;11;) (type 5)
      (local i32)
      block ;; label = @1
        global.get $GOT.data.internal.__memory_base
        i32.const 1048681
    ...
    (func $<miden_sdk_alloc::BumpAlloc as core::alloc::global::GlobalAlloc>::alloc (;12;) (type 8) (param i32 i32 i32) (result i32)
      (local i32 i32)
      block ;; label = @1
        local.get 1
        i32.const 32
    ...
    (func $miden_base_sys::bindings::account::get_id (;13;) (type 3) (result f32)
      call $miden_base_sys::bindings::account::extern_account_get_id
    )
    (func $miden_base_sys::bindings::note::get_inputs (;14;) (type 9) (param i32)
      (local i32 i32 i32)
      global.get $__stack_pointer
      i32.const 16
      i32.sub
    ...
    (func $miden_base_sys::bindings::note::get_assets (;15;) (type 9) (param i32)
      local.get 0
      i32.const 0
      i32.store offset=8
      local.get 0
    ...
    (func $alloc::raw_vec::RawVecInner<A>::deallocate (;16;) (type 7) (param i32 i32 i32)
      (local i32)
      global.get $__stack_pointer
      i32.const 16
      i32.sub
    ...
    (func $alloc::raw_vec::RawVecInner<A>::try_allocate_in (;17;) (type 10) (param i32 i32 i32 i32 i32)
      (local i32 i64)
      global.get $__stack_pointer
      i32.const 16
      i32.sub
    ...
    (func $<alloc::alloc::Global as core::alloc::Allocator>::allocate (;18;) (type 7) (param i32 i32 i32)
      (local i32)
      global.get $__stack_pointer
      i32.const 16
      i32.sub
    ...
    (func $alloc::alloc::Global::alloc_impl (;19;) (type 11) (param i32 i32 i32 i32)
      block ;; label = @1
        local.get 2
        i32.eqz
        br_if 0 (;@1;)
    ...
    (func $alloc::raw_vec::RawVecInner<A>::current_memory (;20;) (type 11) (param i32 i32 i32 i32)
      (local i32 i32 i32)
      i32.const 0
      local.set 4
      i32.const 4
    ...
    (func $<alloc::alloc::Global as core::alloc::Allocator>::deallocate (;21;) (type 7) (param i32 i32 i32)
      block ;; label = @1
        local.get 2
        i32.eqz
        br_if 0 (;@1;)
    ...
    (func $alloc::raw_vec::handle_error (;22;) (type 7) (param i32 i32 i32)
      unreachable
    )
    (func $core::ptr::alignment::Alignment::max (;23;) (type 6) (param i32 i32) (result i32)
      local.get 0
      local.get 1
      local.get 0
      local.get 1
    ...
    (data $.data (;1;) (i32.const 1048620) "\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\01\00\00\00\00\00\10\00)\00\00\00\11\00\00\00!\00\00\00")
  )
  ...
  (type (;7;) (func))
  (alias core export 5 "miden:base/note-script@1.0.0#note-script" (core func (;5;)))
  (func (;5;) (type 7) (canon lift (core func 5)))
  (component (;0;)
    (type (;0;) (func))
