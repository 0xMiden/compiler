(component
  ...
  (core module (;0;)
    ...
    (import "miden:basic-wallet/basic-wallet@1.0.0" "receive-asset" (func $p2id::bindings::miden::basic_wallet::basic_wallet::receive_asset::wit_import7 (;2;) (type 2)))
    (import "miden:core-intrinsics/intrinsics-mem@1.0.0" "heap-base" (func $miden_sdk_alloc::heap_base (;3;) (type 3)))
    (import "miden:core-base/account@1.0.0" "get-id" (func $miden_base_sys::bindings::account::extern_account_get_id (;4;) (type 4)))
    (import "miden:core-base/note@1.0.0" "get-inputs" (func $miden_base_sys::bindings::note::extern_note_get_inputs (;5;) (type 5)))
    (import "miden:core-base/note@1.0.0" "get-assets" (func $miden_base_sys::bindings::note::extern_note_get_assets (;6;) (type 5)))
    (table (;0;) 2 2 funcref)
    (memory (;0;) 17)
    ...
    (func $p2id::bindings::__link_custom_section_describing_imports (;8;) (type 6))
    (func $__rustc::__rust_alloc (;9;) (type 7) (param i32 i32) (result i32)
    ...
    (func $__rustc::__rust_dealloc (;10;) (type 8) (param i32 i32 i32))
    (func $__rustc::__rust_alloc_zeroed (;11;) (type 7) (param i32 i32) (result i32)
      block ;; label = @1
        global.get $GOT.data.internal.__memory_base
        i32.const 1048696
        i32.add
    ...
    (func $miden:base/note-script@1.0.0#note-script (;12;) (type 6)
    ...
    (func $__rustc::__rust_no_alloc_shim_is_unstable_v2 (;13;) (type 6)
      return
    )
    ...
    (func $alloc::raw_vec::RawVecInner<A>::with_capacity_in (;16;) (type 10) (param i32 i32 i32 i32)
      (local i32)
      global.get $__stack_pointer
      i32.const 16
      i32.sub
    ...
    (func $miden_base_sys::bindings::account::get_id (;17;) (type 4) (param i32)
      (local i32)
      global.get $__stack_pointer
      i32.const 16
      i32.sub
    ...
    (func $miden_base_sys::bindings::note::get_inputs (;18;) (type 4) (param i32)
      (local i32 i32 i32)
      global.get $__stack_pointer
      i32.const 16
      i32.sub
    ...
    (func $miden_base_sys::bindings::note::get_assets (;19;) (type 4) (param i32)
      (local i32 i32 i32)
      global.get $__stack_pointer
      i32.const 16
      i32.sub
    ...
    (func $alloc::raw_vec::RawVecInner<A>::deallocate (;20;) (type 8) (param i32 i32 i32)
      (local i32)
      global.get $__stack_pointer
      i32.const 16
      i32.sub
    ...
    (func $alloc::raw_vec::RawVecInner<A>::try_allocate_in (;21;) (type 11) (param i32 i32 i32 i32 i32)
      (local i32 i64)
      global.get $__stack_pointer
      i32.const 16
      i32.sub
    ...
    (func $<alloc::alloc::Global as core::alloc::Allocator>::allocate (;22;) (type 8) (param i32 i32 i32)
      (local i32)
      global.get $__stack_pointer
      i32.const 16
      i32.sub
    ...
    (func $alloc::alloc::Global::alloc_impl (;23;) (type 10) (param i32 i32 i32 i32)
      block ;; label = @1
        local.get 2
        i32.eqz
        br_if 0 (;@1;)
    ...
    (func $alloc::raw_vec::RawVecInner<A>::current_memory (;24;) (type 10) (param i32 i32 i32 i32)
      (local i32 i32 i32)
      i32.const 0
      local.set 4
      i32.const 4
    ...
    (func $<alloc::alloc::Global as core::alloc::Allocator>::deallocate (;25;) (type 8) (param i32 i32 i32)
      block ;; label = @1
        local.get 2
        i32.eqz
        br_if 0 (;@1;)
    ...
    (func $alloc::raw_vec::handle_error (;26;) (type 8) (param i32 i32 i32)
      unreachable
    )
    (func $core::ptr::alignment::Alignment::max (;27;) (type 7) (param i32 i32) (result i32)
      local.get 0
      local.get 1
      local.get 0
      local.get 1
  ...
  (type (;7;) (func))
  (alias core export 5 "miden:base/note-script@1.0.0#note-script" (core func (;7;)))
  (func (;7;) (type 7) (canon lift (core func 7)))
  (component (;0;)
    (type (;0;) (func))
  ...
  (instance (;6;) (instantiate 0
      (with "import-func-note-script" (func 7))
    )
  )
