(component
  ...
  (alias core export 0 "miden:auth-component-no-auth/auth-component-no-auth@0.1.0#auth-procedure" (core func (;0;)))
  ...
  (export (;2;) "miden:auth-component-no-auth/auth-component-no-auth@0.1.0" (instance 1))
)
