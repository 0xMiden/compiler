(component
  ...
  (core module (;0;)
    ...
    (func $counter_contract::bindings::__link_custom_section_describing_imports (;5;) (type 4))
    ...
    (func $miden_base_sys::bindings::storage::get_map_item (;9;) (type 6) (param i32 i32 i32)
      (local i32)
      global.get $__stack_pointer
      i32.const 16
      i32.sub
    ...
    (func $miden_base_sys::bindings::storage::set_map_item (;10;) (type 7) (param i32 i32 i32 i32)
      (local i32)
      global.get $__stack_pointer
      i32.const 32
      i32.sub
    ...
    (func $<miden_stdlib_sys::intrinsics::felt::Felt as core::convert::From<u8>>::from (;11;) (type 0) (param i32) (result f32)
      local.get 0
      i32.const 255
      i32.and
      f32.reinterpret_i32
    )
    (func $<miden_stdlib_sys::intrinsics::word::Word as core::convert::From<miden_stdlib_sys::intrinsics::felt::Felt>>::from (;12;) (type 8) (param i32 f32)
      (local f32 f32 f32)
      i32.const 0
      call $miden_stdlib_sys::intrinsics::felt::extern_from_u32
      local.set 2
  ...
  (alias export 1 "set-map-item" (func (;3;)))
  (core func (;3;) (canon lower (func 3)))
  (core instance (;1;)
    (export "get-map-item" (func 2))
    (export "set-map-item" (func 3))
  )
  ...
  (alias core export 2 "miden:counter-contract/counter@0.1.0#get-count" (core func (;4;)))
  (func (;4;) (type 4) (canon lift (core func 4)))
  (alias core export 2 "miden:counter-contract/counter@0.1.0#increment-count" (core func (;5;)))
  ...
  (instance (;3;) (instantiate 0
      (with "import-func-get-count" (func 4))
      (with "import-func-increment-count" (func 5))
