(component
  ...
  (core module $main (;0;)
    ...
    (func $miden_base_sys::bindings::storage::get_map_item (;2;) (type 1) (param i32 i32)
      (local i32)
    ...
    (func $<miden_stdlib_sys::intrinsics::word::Word>::from_u64_unchecked (;6;) (type 1) (param i32 i32)
      (local f32 f32 f32)
      local.get 1
      i64.load
    ...
    (func $<miden_stdlib_sys::intrinsics::word::Word as core::convert::From<miden_field::wasm32::Felt>>::from (;8;) (type 3) (param i32 f32)
      (local f32 f32 f32)
      i32.const 0
      call $intrinsics::felt::from_u32
      local.set 2
    ...
    (func $intrinsics::felt::add (;9;) (type 4) (param f32 f32) (result f32)
      unreachable
    )
    (func $intrinsics::felt::from_u32 (;10;) (type 5) (param i32) (result f32)
      unreachable
    )
    (func $intrinsics::felt::from_u64_unchecked (;11;) (type 6) (param i64) (result f32)
      unreachable
    )
    (func $<miden_field::wasm32::Felt as core::convert::From<u8>>::from (;12;) (type 5) (param i32) (result f32)
      local.get 0
      i32.const 255
      i32.and
      f32.reinterpret_i32
    )
    (func $miden::active_account::get_map_item (;13;) (type 7) (param f32 f32 f32 f32 f32 i32)
      unreachable
    )
    (func $miden::native_account::set_map_item (;14;) (type 8) (param f32 f32 f32 f32 f32 f32 f32 f32 f32 i32)
      unreachable
    )
