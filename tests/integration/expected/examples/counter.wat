(component
  ...
  (core module $main (;0;)
    ...
    (func $<miden_stdlib_sys::intrinsics::word::Word>::reverse (;6;) (type 1) (param i32 i32)
    ...
    (func $<miden_stdlib_sys::intrinsics::word::Word as core::convert::From<miden_felt::Felt>>::from (;7;) (type 3) (param i32 f32)
      (local f32 f32 f32)
      i32.const 0
      call $intrinsics::felt::from_u32
      local.set 2
    ...
    (func $<miden_felt::Felt as core::convert::From<u8>>::from (;10;) (type 5) (param i32) (result f32)
      local.get 0
      i32.const 255
      i32.and
      f32.reinterpret_i32
