(component
  ...
  (core module $main (;0;)
    ...
    (type (;7;) (func (param f32 f32 f32 f32 i32 i32)))
    ...
    (func $miden:auth-component-rpo-falcon512/auth-component-rpo-falcon512@0.1.0#auth-procedure (;2;) (type 1) (param f32 f32 f32 f32)
      ...
      block ;; label = @1
        loop ;; label = @2
          ...
          local.get 10
          i32.const 4
          call $core::ptr::swap_nonoverlapping_bytes::swap_nonoverlapping_chunks::<4>
          local.get 7
          i32.const 16
          i32.add
          local.set 7
    ...
    (func $core::ptr::swap_nonoverlapping_bytes::swap_nonoverlapping_chunks::<4> (;7;) (type 4) (param i32 i32 i32)
      (local i32)
      block ;; label = @1
        loop ;; label = @2
          local.get 2
    ...
    (func $<miden_stdlib_sys::intrinsics::word::Word>::reverse (;8;) (type 5) (param i32 i32)
    ...
    (func $miden_stdlib_sys::intrinsics::advice::adv_insert (;9;) (type 4) (param i32 i32 i32)
      local.get 0
      f32.load offset=12
      local.get 0
      f32.load offset=8
    ...
    (func $<miden_stdlib_sys::intrinsics::felt::Felt as core::convert::From<u8>>::from (;10;) (type 6) (param i32) (result f32)
      local.get 0
      i32.const 255
      i32.and
      f32.reinterpret_i32
    )
    (func $intrinsics::advice::adv_insert_mem (;11;) (type 7) (param f32 f32 f32 f32 i32 i32)
      unreachable
    )
    (func $intrinsics::advice::emit_falcon_sig_to_stack (;12;) (type 8) (param f32 f32 f32 f32 f32 f32 f32 f32)
      unreachable
    )
    (func $intrinsics::felt::assert_eq (;13;) (type 9) (param f32 f32)
      unreachable
    )
    (func $intrinsics::felt::from_u32 (;14;) (type 6) (param i32) (result f32)
      unreachable
    )
    (func $std::crypto::dsa::rpo_falcon512::verify (;15;) (type 8) (param f32 f32 f32 f32 f32 f32 f32 f32)
      unreachable
    )
    (func $std::crypto::hashes::rpo::hash_memory_words (;16;) (type 4) (param i32 i32 i32)
      unreachable
    )
    (func $miden::active_account::get_item (;17;) (type 10) (param f32 i32)
      unreachable
    )
    (func $miden::native_account::compute_delta_commitment (;18;) (type 3) (param i32)
      unreachable
    )
