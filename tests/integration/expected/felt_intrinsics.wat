(module $felt_intrinsics.wasm
  ...
  (import "miden:core-intrinsics/intrinsics-felt@1.0.0" "div" (func $miden_stdlib_sys::intrinsics::felt::extern_div (;2;) (type 0)))
  (table (;0;) 1 1 funcref)
  (memory (;0;) 16)
  (global $__stack_pointer (;0;) (mut i32) i32.const 1048576)
  (export "memory" (memory 0))
  (export "entrypoint" (func $entrypoint))
  (func $entrypoint (;3;) (type 0) (param f32 f32) (result f32)
    local.get 0
    local.get 0
    local.get 1
  ...
  (func $intrinsics::felt::add (;4;) (type 0) (param f32 f32) (result f32)
    unreachable
  )
)
