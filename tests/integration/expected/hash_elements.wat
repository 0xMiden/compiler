(module $hash_elements.wasm
  ...
  (func $<alloc::alloc::Global as core::alloc::Allocator>::allocate (;11;) (type 2) (param i32 i32 i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $<alloc::alloc::Global as core::alloc::Allocator>::deallocate (;14;) (type 2) (param i32 i32 i32)
    block ;; label = @1
      local.get 2
      i32.eqz
      br_if 0 (;@1;)
  ...
  (func $alloc::raw_vec::handle_error (;15;) (type 2) (param i32 i32 i32)
    unreachable
  )
  ...
  (data $.rodata (;0;) (i32.const 1048576) "miden-stdlib-sys-0.1.5/src/stdlib/crypto/hashes.rs\00\00\00\00\10\002\00\00\00\d5\00\00\00*\00\00\00")
)
