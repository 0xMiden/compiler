(module $hash_elements.wasm
  ...
  (func $entrypoint (;4;) (type 1) (param i32) (result f32)
  ...
  (func $<miden_sdk_alloc::BumpAlloc as core::alloc::global::GlobalAlloc>::alloc (;8;) (type 5) (param i32 i32 i32) (result i32)
    (local i32 i32)
    block ;; label = @1
      local.get 1
      i32.const 16
  ...
  (func $alloc::raw_vec::RawVecInner<A>::try_allocate_in (;10;) (type 6) (param i32 i32 i32 i32 i32)
    (local i32 i64)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $alloc::alloc::Global::alloc_impl (;12;) (type 7) (param i32 i32 i32 i32)
    block ;; label = @1
      local.get 2
      i32.eqz
      br_if 0 (;@1;)
  ...
  (func $alloc::raw_vec::RawVecInner<A>::current_memory (;13;) (type 7) (param i32 i32 i32 i32)
    (local i32 i32 i32)
    i32.const 0
    local.set 4
    i32.const 4
