...
fn basic_wallet_and_p2id() {
    ...
    expect!["16071"].assert_eq(stripped_mast_size_str(&account_package));
    ...
    expect!["19732"].assert_eq(stripped_mast_size_str(&note_package));
    ...
    expect!["22960"].assert_eq(stripped_mast_size_str(&p2ide_package));
}
