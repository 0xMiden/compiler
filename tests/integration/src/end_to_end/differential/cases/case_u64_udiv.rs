...
// miden-core-lib `::miden::core::math::u64::{div,mod}` procedures. The
// `u64::div` advice event (`emit.U64_DIV_EVENT`) requires the executor to
// register the core-library event handlers; the differential executor does.
#[unsafe(no_mangle)]
