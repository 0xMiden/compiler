// Bounding sibling of `prog_sponge` (campaign 21): the same eight-lane
// sponge — an absorb loop and a squeeze loop sharing the permutation's
// rotation offsets — with FOUR distinct rotation offsets instead of eight.
const R0: u32 = 5;
const R1: u32 = 13;
const R2: u32 = 21;
const R3: u32 = 29;
