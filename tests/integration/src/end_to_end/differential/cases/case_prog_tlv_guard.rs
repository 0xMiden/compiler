// Bounding sibling of `prog_tlv` (campaign 21): the same nested TLV record
// validator — container check, record-header check and value check, with the
// digest words read only on the innermost accepted path — with TWO digest
// words instead of eight.
const D0: u32 = 7;
const D1: u32 = 19;
const D2: u32 = 31;
const D3: u32 = 43;
