...
fn basic_wallet_and_p2id() {
    ...
    expect!["16244"].assert_eq(stripped_mast_size_str(&account_package));
    ...
    expect!["17910"].assert_eq(stripped_mast_size_str(&tx_script_package));
    ...
    expect!["20417"].assert_eq(stripped_mast_size_str(&note_package));
    ...
    expect!["23904"].assert_eq(stripped_mast_size_str(&p2ide_package));
}
