...
fn basic_wallet_and_p2id() {
    ...
    expect!["35596"].assert_eq(stripped_mast_size_str(&account_package));
    ...
    expect!["55376"].assert_eq(stripped_mast_size_str(&tx_script_package));
    ...
    expect!["52965"].assert_eq(stripped_mast_size_str(&note_package));
    ...
    expect!["59086"].assert_eq(stripped_mast_size_str(&p2ide_package));
}
