...
fn basic_wallet_and_p2id() {
    ...
    expect!["36630"].assert_eq(stripped_mast_size_str(&account_package));
    ...
    expect!["56999"].assert_eq(stripped_mast_size_str(&tx_script_package));
    ...
    expect!["55262"].assert_eq(stripped_mast_size_str(&note_package));
    ...
    expect!["61528"].assert_eq(stripped_mast_size_str(&p2ide_package));
}
