...
fn basic_wallet_and_p2id() {
    ...
    expect!["15796"].assert_eq(stripped_mast_size_str(&account_package));
    ...
    expect!["17045"].assert_eq(stripped_mast_size_str(&tx_script_package));
    ...
    expect!["19777"].assert_eq(stripped_mast_size_str(&note_package));
    ...
    expect!["23039"].assert_eq(stripped_mast_size_str(&p2ide_package));
}
