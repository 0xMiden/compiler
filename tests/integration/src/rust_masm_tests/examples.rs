...
fn basic_wallet_and_p2id() {
    ...
    expect!["15861"].assert_eq(stripped_mast_size_str(&account_package));
    ...
    expect!["17167"].assert_eq(stripped_mast_size_str(&tx_script_package));
    ...
    expect!["19874"].assert_eq(stripped_mast_size_str(&note_package));
    ...
    expect!["23235"].assert_eq(stripped_mast_size_str(&p2ide_package));
}
