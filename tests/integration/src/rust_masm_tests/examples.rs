...
fn basic_wallet_and_p2id() {
    ...
    expect!["35488"].assert_eq(stripped_mast_size_str(&account_package));
    ...
    expect!["55266"].assert_eq(stripped_mast_size_str(&tx_script_package));
    ...
    expect!["52857"].assert_eq(stripped_mast_size_str(&note_package));
    ...
    expect!["58978"].assert_eq(stripped_mast_size_str(&p2ide_package));
}
