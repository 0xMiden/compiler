...
;; RUN: midenc %s -Zprint-hir-source-locations --emit=hir=- -Canalyze-only 2>&1 | filecheck %s --check-prefix=HIR-LOC
;;
...
;; HIR-ADD-LABEL: builtin.function public extern("C") @test_felt_add
;; HIR-ADD: arith.add {{.*}};
;; HIR-ADD: builtin.ret
