...
// Options used:
//   * skip: ["remove-asset", "create-note", "heap-base", "hash-one-to-one", "hash-two-to-one", "add-asset", "add", "unchecked-from-u64"]
...
//   * with "miden:base/core-types@1.0.0/core-asset" = "miden::CoreAsset"
        ...
        pub mod intrinsics_felt {
            ...
            pub fn eq(a: f32, b: f32) -> bool {
                unsafe {
                    ...
                    extern "C" fn wit_import0(_: f32, _: f32) -> i32 {
                        unreachable!()
                    }
                    let ret = wit_import0(_rt::as_f32(&a), _rt::as_f32(&b));
            ...
            pub fn from_u64_unchecked(a: u64) -> f32 {
                unsafe {
                    ...
                    #[cfg(not(target_arch = "wasm32"))]
                    extern "C" fn wit_import0(_: i64) -> f32 {
                        unreachable!()
                    }
                    let ret = wit_import0(_rt::as_i64(&a));
                    ret
                }
            }
            #[allow(unused_unsafe, clippy::all)]
            pub fn from_u32(a: u32) -> f32 {
                unsafe {
                    ...
                    #[cfg(not(target_arch = "wasm32"))]
                    extern "C" fn wit_import0(_: i32) -> f32 {
                        unreachable!()
                    }
                    let ret = wit_import0(_rt::as_i32(&a));
                    ret
                }
            }
            #[allow(unused_unsafe, clippy::all)]
            pub fn assert_eq(a: f32, b: f32) -> () {
                unsafe {
                    ...
                    #[cfg(not(target_arch = "wasm32"))]
                    extern "C" fn wit_import0(_: f32, _: f32) {
                        unreachable!()
                    }
                    wit_import0(_rt::as_f32(&a), _rt::as_f32(&b));
                }
            }
        }
        #[allow(dead_code, unused_imports, clippy::all)]
        ...
        pub mod note {
            ...
            pub fn get_inputs(ptr: i32) -> i32 {
                unsafe {
                    ...
                    let ret = wit_import0(_rt::as_i32(&ptr));
                    ret
                }
            }
            #[allow(unused_unsafe, clippy::all)]
            ...
            pub mod basic_wallet {
                ...
                macro_rules! __export_miden_basic_wallet_basic_wallet_1_0_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        #[unsafe (export_name =
                        "miden:basic-wallet/basic-wallet@1.0.0#send-asset")] unsafe
                        extern "C" fn export_send_asset(arg0 : f32, arg1 : f32, arg2 :
                        f32, arg3 : f32, arg4 : f32, arg5 : f32, arg6 : f32, arg7 : f32,
                        arg8 : f32, arg9 : f32,) { $($path_to_types)*::
            ...
            pub mod aux {
                ...
                macro_rules! __export_miden_basic_wallet_aux_1_0_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        _export_test_felt_intrinsics_cabi::<$ty > (arg0, arg1) } #[unsafe
                        ...
                        _export_test_stdlib_cabi::<$ty > (arg0, arg1) } #[unsafe
                        (export_name =
                        ...
                        #[unsafe (export_name =
                        "miden:basic-wallet/aux@1.0.0#process-list-felt")] unsafe extern
                        "C" fn export_process_list_felt(arg0 : * mut u8, arg1 : usize,)
                        -> * mut u8 { $($path_to_types)*::
                        _export_process_list_felt_cabi::<$ty > (arg0, arg1) } #[unsafe
                        (export_name =
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.39.0:miden:basic-wallet@1.0.0:basic-wallet-world:encoded world"
)]
#[doc(hidden)]
...
A\x17\x01B\x02\x01@\0\0z\x04\0\x09heap-base\x01\0\x03\0&miden:core-import/intrin\
sics-mem@1.0.0\x05\0\x01B\x0a\x01@\x02\x01av\x01bv\0v\x04\0\x03add\x01\0\x01@\x02\
\x01av\x01bv\0\x7f\x04\0\x02eq\x01\x01\x01@\x01\x01aw\0v\x04\0\x12from-u64-unche\
cked\x01\x02\x01@\x01\x01ay\0v\x04\0\x08from-u32\x01\x03\x01@\x02\x01av\x01bv\x01\
\0\x04\0\x09assert-eq\x01\x04\x03\0'miden:core-import/intrinsics-felt@1.0.0\x05\x01\
\x01B\x02\x01@\x09\x02a0z\x02a1z\x02a2z\x02a3z\x02a4z\x02a5z\x02a6z\x02a7z\x0are\
sult-ptrz\x01\0\x04\0\x0fhash-one-to-one\x01\0\x03\03miden:core-import/stdlib-cr\
ypto-hashes-blake3@1.0.0\x05\x02\x01B\x05\x01@\x05\x06asset0v\x06asset1v\x06asse\
t2v\x06asset3v\x0aresult-ptrz\x01\0\x04\0\x09add-asset\x01\0\x04\0\x0cremove-ass\
et\x01\0\x01@\0\0v\x04\0\x06get-id\x01\x01\x03\0\x1fmiden:core-import/account@1.\
0.0\x05\x03\x01B\x03\x01@\x01\x03ptrz\0z\x04\0\x0aget-inputs\x01\0\x04\0\x0aget-\
assets\x01\0\x03\0\x1cmiden:core-import/note@1.0.0\x05\x04\x01B\x02\x01@\x0a\x06\
asset0v\x06asset1v\x06asset2v\x06asset3v\x03tagv\x09note-typev\x0arecipient0v\x0a\
recipient1v\x0arecipient2v\x0arecipient3v\0v\x04\0\x0bcreate-note\x01\0\x03\0\x1a\
miden:core-import/tx@1.0.0\x05\x05\x01B\x1f\x01r\x01\x05innerv\x04\0\x04felt\x03\
\0\0\x01o\x04\x01\x01\x01\x01\x01r\x01\x05inner\x02\x04\0\x04word\x03\0\x03\x01r\
\x01\x05inner\x01\x04\0\x0aaccount-id\x03\0\x05\x01r\x01\x05inner\x04\x04\0\x09r\
ecipient\x03\0\x07\x01r\x01\x05inner\x01\x04\0\x03tag\x03\0\x09\x01r\x01\x05inne\
r\x04\x04\0\x0acore-asset\x03\0\x0b\x01r\x01\x05inner\x01\x04\0\x05nonce\x03\0\x0d\
\x01r\x01\x05inner\x04\x04\0\x0caccount-hash\x03\0\x0f\x01r\x01\x05inner\x04\x04\
\0\x0ablock-hash\x03\0\x11\x01r\x01\x05inner\x04\x04\0\x0dstorage-value\x03\0\x13\
\x01r\x01\x05inner\x04\x04\0\x0cstorage-root\x03\0\x15\x01r\x01\x05inner\x04\x04\
\0\x11account-code-root\x03\0\x17\x01r\x01\x05inner\x04\x04\0\x10vault-commitmen\
t\x03\0\x19\x01r\x01\x05inner\x01\x04\0\x07note-id\x03\0\x1b\x01r\x01\x05inner\x01\
\x04\0\x09note-type\x03\0\x1d\x03\0\x1bmiden:base/core-types@1.0.0\x05\x06\x02\x03\
\0\x06\x0acore-asset\x02\x03\0\x06\x03tag\x02\x03\0\x06\x09recipient\x02\x03\0\x06\
\x09note-type\x02\x03\0\x06\x04felt\x01B\x0e\x02\x03\x02\x01\x07\x04\0\x0acore-a\
...
ecipient\x05\x01\0\x04\0\x0asend-asset\x01\x0b\x04\0%miden:basic-wallet/basic-wa\
llet@1.0.0\x05\x0c\x01B\x14\x02\x03\x02\x01\x07\x04\0\x0acore-asset\x03\0\0\x02\x03\
\x02\x01\x08\x04\0\x03tag\x03\0\x02\x02\x03\x02\x01\x09\x04\0\x09recipient\x03\0\
\x04\x02\x03\x02\x01\x0a\x04\0\x09note-type\x03\0\x06\x02\x03\x02\x01\x0b\x04\0\x04\
felt\x03\0\x08\x01@\x02\x01a\x09\x01b\x09\0\x09\x04\0\x14test-felt-intrinsics\x01\
...
\0\x01\x04\0\x12process-core-asset\x01\x0f\x04\0\x1cmiden:basic-wallet/aux@1.0.0\
\x05\x0d\x04\0+miden:basic-wallet/basic-wallet-world@1.0.0\x04\0\x0b\x18\x01\0\x12\
basic-wallet-world\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-compon\
ent\x070.225.0\x10wit-bindgen-rust\x060.39.0";
#[inline(never)]
#[doc(hidden)]
