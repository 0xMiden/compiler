(module $onchain_mixed_types_no_u64.wasm
  ...
  (type (;9;) (func (param f32) (result i64)))
  ...
  (func $entrypoint (;2;) (type 2) (param i32 i32)
    (local i32 f32 f32 f32 f32 i64 i64 i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
    local.tee 2
  ...
  (func $intrinsics::felt::as_u64 (;10;) (type 9) (param f32) (result i64)
    unreachable
  )
  ...
  (func $alloc::raw_vec::RawVecInner<A>::current_memory (;15;) (type 13) (param i32 i32 i32 i32)
    (local i32 i32 i32)
    i32.const 0
    local.set 4
    i32.const 4
  ...
  (func $alloc::raw_vec::finish_grow (;16;) (type 11) (param i32 i32 i32 i32 i32)
    (local i32 i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $alloc::raw_vec::handle_error (;17;) (type 12) (param i32 i32 i32)
    unreachable
  )
  (func $core::ptr::alignment::Alignment::max (;18;) (type 3) (param i32 i32) (result i32)
    local.get 0
    local.get 1
    local.get 0
    local.get 1
