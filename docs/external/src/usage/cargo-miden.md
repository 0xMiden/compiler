...
Check out the [examples](https://github.com/0xMiden/compiler/tree/next/examples) for some `cargo-miden` project examples. For tutorials with step-by-step guides, see the [Miden tutorials](https://docs.miden.xyz/next/miden-tutorials/rust-client/).
