...
- The component WIT generated by `#[component]` is now embedded in the compiled Miden package (a
  ...
  `miden-project.toml` are no longer read, and dependency packages built by older toolchains are
  rejected. See [MIGRATION.md](./MIGRATION.md) for the manifest edits and rebuild steps.
