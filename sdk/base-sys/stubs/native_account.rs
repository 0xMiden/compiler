...
#[unsafe(export_name = "miden::protocol::native_account::has_state_changed")]
#[optimize(none)]
#[inline(never)]
pub extern "C" fn native_account_has_state_changed_plain() -> f32 {
    unsafe { core::hint::unreachable_unchecked() }
}

#[unsafe(export_name = "miden::protocol::native_account::has_initial_asset")]
#[optimize(none)]
#[inline(never)]
pub extern "C" fn native_account_has_initial_asset_plain(
    _asset_id_0: f32,
    _asset_id_1: f32,
    _asset_id_2: f32,
    _asset_id_3: f32,
