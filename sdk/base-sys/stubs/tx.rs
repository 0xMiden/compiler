...
define_stub! {
    ...
    pub extern "C" fn tx_get_block_commitment_plain(out: *mut c_void);
}
...
define_stub! {
    ...
    pub extern "C" fn tx_get_input_notes_commitment_plain(out: *mut c_void);
}

define_stub! {
    #[unsafe(export_name = "miden::protocol::tx::get_output_notes_commitment")]
    pub extern "C" fn tx_get_output_notes_commitment_plain(out: *mut c_void);
}
...
define_stub! {
    ...
    pub extern "C" fn tx_update_expiration_block_delta_plain(delta: f32);
}
