...
// This is explicit and intentional - this crate runs in user build scripts, and warnings caused
// due to new nightly lints or compiler warnings should not break their builds by using `deny` here
#![allow(warnings)]
