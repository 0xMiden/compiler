...
- BREAKING: The component WIT generated by `#[component]` is now embedded in the compiled Miden
  ...
  `wit = "..."` keys in `miden-project.toml` are no longer read, and dependency packages built by
  older toolchains are rejected. See the [migration guide](./sdk/sdk/MIGRATION.md) for the
  manifest edits and rebuild steps #1248
