...
///
/// ```text,ignore
/// %0:2 = hir.while () : () -> (i32, i64) {
///     %condition = "test.condition"() : () -> i1
///     %v1 = "test.get_some_value"() : () -> i32
///     %v2 = "test.get_some_value"() : () -> i64
///     hir.condition(%condition) %v1, %v2 : i32, i64
/// } do {
...
///     %v1 = "test.get_some_value"() : () -> i32
///     %v2 = "test.get_some_value"() : () -> i64
///     hir.condition(%condition) %v1 : i32
/// } do {
/// ^bb0(%arg0: i32):
///     "test.use"(%arg0) : (i32) -> ()
///     hir.yield
...
impl RewritePattern for WhileUnusedResult {
    ...
    fn match_and_rewrite(
...

        {
            ...
            let new_condition = builder.condition(condition, new_term_args, span)?;
        ...
        let new_while = {
            ...
            builder.r#while(inits, &new_result_types, span)?
        };
