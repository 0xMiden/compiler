...
use midenc_hir2::{AttributeValue, Immediate, Type, ValueRef};
...
mod tests {
    ...
    use midenc_hir2::{BuilderExt, Context, StructType};
    ...
    fn operand_stack_values_test() {
        ...
        // rename
        let four = {
            let mut builder = midenc_hir2::OpBuilder::new(context.clone());
