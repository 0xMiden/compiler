**NOTE:** Entries in this file were produced automatically by our older release tooling. They are kept here for historical reference, but are of limited value in terms of understanding the impact of various changes.

## [0.9.2]

## `midenc-hir-opt` - [0.9.2](https://github.com/0xMiden/compiler/compare/midenc-hir-opt-v0.9.1...midenc-hir-opt-v0.9.2) - 2026-07-09

### Other
- update Cargo.lock dependencies

## `cargo-miden` - [0.9.2](https://github.com/0xMiden/compiler/compare/v0.9.1...v0.9.2) - 2026-07-09

### Other
- update new project template before the v0.9.2 compiler release

## `midenc` - [0.9.2](https://github.com/0xMiden/compiler/compare/midenc-v0.9.1...midenc-v0.9.2) - 2026-07-09

### Other
- update Cargo.lock dependencies

## `midenc-frontend-wasm` - [0.9.2](https://github.com/0xMiden/compiler/compare/midenc-frontend-wasm-v0.9.1...midenc-frontend-wasm-v0.9.2) - 2026-07-09
...
## `midenc-codegen-masm` - [0.9.2](https://github.com/0xMiden/compiler/compare/midenc-codegen-masm-v0.9.1...midenc-codegen-masm-v0.9.2) - 2026-07-09

### Other
- *(codegen)* load and store element-space pointers with bare memory ops ([#1260](https://github.com/0xMiden/compiler/pull/1260))

## `midenc-hir` - [0.9.2](https://github.com/0xMiden/compiler/compare/midenc-hir-v0.9.1...midenc-hir-v0.9.2) - 2026-07-09
