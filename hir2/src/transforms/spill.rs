...
use crate::{
    ...
    SourceSpan, Spanned, StorableEntity, Usable, ValueRange, ValueRef,
};
...
fn rewrite_cfg_spills(
    ...
    let domtree = dominfo.info().dominance(region);
...
fn rewrite_spill_pseudo_instructions(
    ...
    use crate::{dominance::Dominates, NoopRewriterListener, RewriterImpl};
